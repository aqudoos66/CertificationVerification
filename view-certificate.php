...
<head>
    ...
    <link rel="stylesheet" href="E-certificate/styles.css">
</head>
<body>
...
<div class="certificate-container">
    ...
    <div class="title-section">
        <div> 
            <img src="E-certificate/assets/TTB-stevta.jpg" alt="Logo" class="logo">
        </div>
        <div style="display: flex; flex-direction: column; align-items: center;">
            <img src="E-certificate/assets/logo.png" alt="Logo" class="logo" style="width: 140px; height: 140px">
        ...
        <div>
            <img src="E-certificate/assets/stevta-removebg-preview.png" alt="Logo" class="logo">
        </div>
    </div>
...
window.onafterprint = function() {
    window.location.href = "view-candidate.php";
};
</script>
